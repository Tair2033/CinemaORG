      ...
      <section class="main__section">
        <div class="main__title">
          <div class="main__image">
            <img
              loading="lazy"
              src="https://images.hdqwalls.com/download/daenerys-targaryen-4k-iu-2560x1024.jpg"
              alt=""
            />
            ...
            <div class="main__about">
              <div class="main__about-logo">
                <img
                  loading="lazy"
                  src="https://i.servimg.com/u/f62/19/77/94/54/mbr8wj10.png"
                  alt=""
                />
              </div>

              <div class="main__about-description">
                К концу подходит время благоденствия, и лето, длившееся почти
                десятилетие, угасает. Вокруг средоточия власти Семи королевств,
                Железного трона, зреет заговор, и в это непростое время король
                решает искать поддержки у друга юности Эддарда Старка.
              </div>

              <div class="main__about-button">
                <router-link to="/film/464963"> На страницу </router-link>
              </div>
            </div>
          </div>
        </div>
      ...
      <section class="content__section">
        <router-link to="/film/590286" class="content__info content__batman">
          ...
          <p class="content__par">
            Американский художественный фильм 2022 года режиссёра Мэтта Ривза c
            Робертом Паттинсоном в главной роли. Перезапуск серии фильмов c
            Бэтмене.
          </p>
          ...
          <span class="content__about content__batman-about">
            Режиссер:
            <strong class="content__about-text"> Мэтт Ривз </strong>
          </span>
        </router-link>

        <iframe
          width="600"
          src="https://www.youtube-nocookie.com/embed/hbnx6DJQ3xU?si=P0WyrSMpD6D_DPyf&amp;controls=0"
      ...
      <section class="content__section">
        <router-link to="/film/404900" class="content__info content__bad">
          <img
            loading="lazy"
            class="content__img"
            src="https://logodix.com/logo/315391.png"
            alt=""
          />
          <p class="content__par">
            ...
            привлекает своего бывшего ученика Джесси Пинкмана, когда-то
            исключённого из школы при активном содействии Уайта.
          </p>
        ...
        <iframe
          width="600"
          src="https://www.youtube-nocookie.com/embed/ceqOTZnhgY8?si=_Q7I2PGd13sMf310&amp;controls=0"
          title="YouTube video player"
          frameborder="0"
          allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share"
          allowfullscreen
...
<style scoped lang="scss">
  ...
  .content__bad:hover {
    background: linear-gradient(
      0deg,
      rgba(55, 111, 36, 0.864) 52%,
      rgba(137, 206, 63, 0.792) 86%
    );
  }
