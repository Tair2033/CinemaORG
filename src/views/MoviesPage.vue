            ...
            <div class="filter__inputs">
              ...
              <div class="filter__double">
                <input
                  ...
                  min="1900"
                  v-model="filterItems.minYear"
                  class="filter__input input-left"
                />
                ...
                <input
                  ...
                  min="2000"
                  v-model="filterItems.maxYear"
                  class="filter__input input-right"
                />
              </div>
            </div>
          </div>
          ...
          <div class="" v-show="$store.state.loading.MoviesPage">
            <form class="movies__form">
              ...
              <div class="movies__search movies__form-type">
                <input
                  type="search"
                  @keydown.enter.prevent="searchRequest"
                  v-model="searchInput"
