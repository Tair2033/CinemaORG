    ...
    <div class="container">
      ...
      <div class="top-wrapper">
        <div class="top">
          ...
          <div class="top-img">
            <img class="top-img__element" :src="currrentSection.logo || null" alt="img" />
          </div>
        </div>
        ...
        <div v-if="!$store.state.loading.topPage">
          <div class="list">
            <app-title-item v-for="(item, id) in content" :currentPage="$store.state.pageCounter" :item="item" :key="id"
              :id="id"></app-title-item>
          </div>
        </div>
    ...
    switch (this.pageType) {
      ...
      case "top100":
        this.currrentSection = {
          ...
          description: "Рейтинг составлен на основе посещаемости страниц фильмов, а также запросов к поисковой системе сайта. Список обновляется один раз в сутки.",
      ...
      case "awaiting":
        this.currrentSection = {
          ...
          description: "Рейтинг составлен на основе пользовательских голосов, любой зарегистрированный посетитель сайта может легко принять в нём участие.",
