      ...
      <div class="container-title">
          ...
          <div class="title-center">
            <div class="title-center__top">
              <div class="title-center__heading">
                ...
                <div
                  class="title-center__originalname"
                  :style="{ fontSize: isOriginalName }"
                >
              ...
              <div
                class="title-center__line"
                v-show="!currentPageData.ratingKinopoisk"
              >
                -
            ...
            <div class="title-center__center">
              <div class="title-center__buttons">
                <div
                  class="title-center__tickets"
                  v-if="!currentPageData.serial"
                >
                  Расписание и билеты
                </div>
                <div
                  class="title-center__status"
                  v-if="!currentPageData.serial"
                >
                  <span> ... </span>
                </div>
        ...
        <div class="title-bottom">
          <ul class="title-bottom__menu">
            <li
              :style="id == selectedMenuItemId ? activeStyle : null"
          ...
          <div
            class="title-bottom__description"
            v-if="selectedMenuItemId !== 1"
          >
            {{ currentPageData.description }}
          </div>

          <div
            class="title-bottom__ratingsection"
            v-if="selectedMenuItemId !== 1"
          >
            <div class="title-raiting">
              ...
              <div
                :style="{ color: ratingColor }"
                class="title-bottom__ratingKinopoisk"
              >
                {{ currentPageData.ratingKinopoisk }}
              </div>
          ...
          <div class="title-bottom__reviews">
            <app-review
              v-for="(review, id) in reviews.items"
              :data="review"
              :key="id"
            ></app-review>
          </div>
