<template>
  <div class="slider__wrapper">
    <div class="slider__arrow arrow__left" v-if="calculateLeft" @click="leftAction">&larr;</div>
    <div class="slider__arrow arrow__right" v-if="calculateRight" @click="rightAction">&rarr;</div>

    <div class="slider__main" ref="sliderSize">
      <div class="slider">
        <div class="slider__inside" ref="slider">
          <app-slider-item class="slider__item" v-for="(item, id) in data" :item="item" :key="id"></app-slider-item>
        </div>
      </div>
    </div>
  </div>
