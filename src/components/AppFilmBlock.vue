    ...
    <div class="cinema" @click="goToPage">
      <div class="cinema__image">
        <div class="cinema__image-inside">
          ...
          <div
            class="cinema__raiting"
            :style="{
              backgroundColor: ratingColorChanger(item.ratingKinopoisk),
              display: checkRating(item.ratingKinopoisk)
            }"
          >
          ...
          <div class="cinema__bookmark">
            <div
              class="cinema__bookmark-default"
              ...
              >
                ...
                >
                  <g
                    ...
                    transform="translate(-305.000000, -2639.000000)"
            ...
            <div
              class="cinema__bookmark-selected"
              @click="toggleBookmark"
              v-if="isSelected"
            >
              <svg
              ...
              >
                ...
                >
                  <g
                    id="Dribbble-Light-Preview"
                    transform="translate(-145.000000, -2639.000000)"
