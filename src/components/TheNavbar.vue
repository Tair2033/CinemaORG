  ...
  <nav class="navbar">
    <div class="container">
      <div class="havbar__inside">
        <router-link to="/" class="logo"> CinemaORG </router-link>
        ...
        <ul class="menu">
          <li class="menu__item">
            <router-link to="/" class="menu__item-link">Главная </router-link>
          </li>
          <li class="menu__item">
        ...
        <TheAuthedUser v-if="$store.state.isAuth" :user="user"></TheAuthedUser>
